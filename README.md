...
- Lead_Score_Case_Study.ipynb: The Jupyter Notebook-based Python file showing coding and data analysis.
- Assignment Subjective Questions.pdf: Contains answers for subjective questions related to the assignment.
- Presentation.pdf: Contains Final Presentation.
- Summary.pdf: Summary of what's done in the entire assignment.
